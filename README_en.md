...
- `changzhi-jincheng-7d6n-real.html` — Changzhi & Jincheng, 7D6N (Mode A: fly + rental-car loop from Shanghai; national-heritage temples + Taihang canyons; leg-by-leg drive chain, no-mountain-roads-after-dark scheduling, chain-hotel-first picks, Gaoping heritage deep-dive (Kaihua Temple murals, Ji residence, Tiefo Temple), rail-via-Zhengzhou fallback, dateTBD estimated-date banner)
